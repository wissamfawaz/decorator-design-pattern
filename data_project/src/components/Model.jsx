...
function Model() {
  ...
  return (
    ...
    <Canvas style = {{backgroundImage: "url('https://img.freepik.com/premium-photo/modern-brand-new-home-garage-interior-background_1372-1356.jpg?w=2000')", objectFit: "fit", backgroundRepeat : 'no-repeat', backgroundSize :'cover'}} camera={{ fov: 100, position : [130, 10, -100]}}>
      ...
      <button disabled = {true} style={{marginRight : "20px", backgroundColor : "white", color : "black", borderRadius : "20px", padding : "10px", fontSize : "20px", fontWeight : "500"}}>Total Price: ${totalPrice}</button>
      </div>
      </div>
      ...
      <button
            ...
            onClick={() => {
              addMesh({
                ...
                material: materials.Everything_else,
                materialName: "Wheels, Seat and Pedals",
                position: [0, 34.6, 19.54],
              });
              AddPrice(20);
              setBoo(!boo);
            }}
            disabled={boo ? false : true}
          > Add Seat + $20 </button>
      </div>
      ...
      <button
            ...
            onClick={() => {
              removeMeshById("iPhoneMount");
              RemovePrice(10);
              setBo(!bo);
            }}
            disabled={bo ? true : false}
          >
            Remove iPhone Mount - $10
          </button>
          ...
          <button
            ...
            onClick={() => {
              addMesh({
                id: "iPhoneMount",
                geometry: nodes.Bike_mount_iPhone6.geometry,
                material: nodes.Bike_mount_iPhone6.material,
                materialName: "iPhone Mount",
                position: [-0.93, 63.83, -50.1],
                rotation: [1.42, -0.02, -1.55],
                scale: 0.08,
              });
              AddPrice(10);
              setBo(!bo);
            }}
            disabled={bo ? false : true}
          >
            Add iPhone Mount + $ 10
          </button>
      </div>
      ...
      <button
            ...
            onClick={() => {
              removeMeshById("GoProMount");
              RemovePrice(15);
              setB(!b);
            }}
            disabled={b ? true : false}
          >
            Remove GoPro Mount -15$
          </button>
          ...
          <button
            ...
            onClick={() => {
              addMesh({
                id: "GoProMount",
                geometry: nodes.bike_Mount.geometry,
                material: materials["Bike Mount"],
                materialName: "GoPro Mount",
                position: [42.82, 51.13, -37.56],
